...
namespace EventsInventLib
{
    internal class CInvInputEvents
    {
        ...
        public delegate void CInventorEvents_OnSelect_DelegateHandler(ref Inventor.AssemblyDocument AssemblyDocument, ref Inventor.ObjectCollection ObjectCollection);
