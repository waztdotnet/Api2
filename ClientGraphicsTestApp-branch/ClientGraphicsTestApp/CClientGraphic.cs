    ...
    public class CClientGraphic
    {
        ...
        public static void Draw(ref Inventor.Application _InvApplication, string Type)
        {
            ...
            if (Type == "Run")
            {
                ...
                // TestSetHighLightSet(ref _InvApplication, ref assemblyDocument, ref Occurrences, "");
            }
            else
            {
                DeleteNamedGraphics(ref assemblyDocument, GraphicsName);
        ...
        private static void TestSetHighLightSet(ref Inventor.Application _InvApplication, ref Inventor.AssemblyDocument assemblyDocument, ref Inventor.ComponentOccurrences Occurrences, string GraphicsName)
        {
